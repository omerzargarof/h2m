...
Editing:  
/home/halachat/public_html/contactfortfilin.php
...
<!--=========== END HEADER SECTION ================-->      
 ...
 <div class="section-heading">
              <h3><b> <p> מלא את פרטיך ונחזור אליך בהקדם</p></b>  </h3> 
                <div class="line"></div> <a href="http://halacha-to-m.co.il/contactfortfilin.php"><input type="submit" class="wp-form-control wpcf7-text" value="נקה עמוד"></a>
              </div>
</center>

    <form method="post" action="contactfortfilin.php">
...
<textarea rows="5" cols="10" name="message" class="wp-form-control wpcf7-text" placeholder="הודעה: באלו קורסים אתה מתעניין? יש לך מה להוסיף?"></textarea> 
<left><?=$thankYou ?></left>

...
<!--=========== END HEADER SECTION ================-->      
 ...
 <div class="section-heading">
              <h3><b> <p> מלא את פרטיך ונחזור אליך בהקדם</p></b>  </h3> 
                <div class="line"></div> <a href="http://halacha-to-m.co.il/contactforstam.php"><input type="submit" class="wp-form-control wpcf7-text" value="נקה עמוד"></a>
              </div>
</center>

    <form method="post" action="contactforstam.php">
